...
export default function Groups() {
    ...
    async function adminMenuSwitcher(group: any) {
        ...
        if (adminMenu && adminMenu.className == "hidden") {
            ...
            adminMenu.className = "absolute ml-[12%] border-solid border-2 border-black w-42 h-26 text-black"
        }
                            ...
                            <div className="w-1/3 h-full text-sm/6 text-orange-300 mr-1">
                                {
                                    isAlreadyAdmin(group) ? (
                                        <div className="flex flex-row">
                                            <div onClick={() => { adminMenuSwitcher(group) }} className="flex w-full justify-end hover:text-orange-600">
                                            ...
                                            <div // CLOSE ON OPENING ANOTHER ADMINMENU?
                                                id={`${group.id}`}
                                                className="hidden">
                                                <AdminMenu

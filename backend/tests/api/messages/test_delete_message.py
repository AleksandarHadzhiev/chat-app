...
test_data = [
    ...
    ("/messages?code=&group_id=&user_id=", {"status": 400, "json":{'fail': 'Incorrect data'}}),
    ("/messages?some=&other=&queries=", {"status": 400, "json":{'fail': 'Incorrect data'}}),
    ("/messages?code=s&group_id=0&user_id=s", {"status": 400, "json":{'fail': 'Incorrect data'}}),
    ("/messages?code=wqwe&group_id=1&user_id=1", {"status": 200, "json": {'message': 'success'}}),
]

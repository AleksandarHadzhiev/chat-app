...
test_data = [
    ...
    ('/messages/2', {"status": 200, "json":{'message': [{'id': 1, 'author': 'Administrator', 'user_id': 2, 'content': 'Chat has been created', 'group_id': 2, 'code': '2-2-2023-01-01-12-00-00', 'created_at': '2023-01-01 12:00:00'}]}}),

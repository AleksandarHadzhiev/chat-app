...
test_data = [
    ...
    ({"email": "", "code": ""}, {"status": 400, "json":{'fail': ['empty-email', 'empty-code']}}),
    ({"email": "invalid.email.com", "code": ""}, {"status": 400, "json":{'fail': ['invalid-email', 'empty-code']}}),
    ({"email": "", "code": "swwww"}, {"status": 400, "json":{'fail': ['empty-email', 'invalid-code']}}),
    ({"email": "", "code": "swww"}, {"status": 400, "json":{'fail': ['empty-email']}}),
    ({"email": "user-not-found@gmail.com", "code": ""}, {"status": 400, "json":{'fail': ['user-not-found', 'empty-code']}}),
    ({"email": "user-not-found@gmail.com", "code": "swwqq"}, {"status": 400, "json":{'fail': ['user-not-found', 'invalid-code']}}),
    ({"email": "unverified@gmail.com", "code": "swqq"}, {"status": 400, "json":{"fail": "unverified"} }),
]
...
def test_verify_success(api, get_code):
    ...
    else: logging.error(msg="Failed at fetching code from message")
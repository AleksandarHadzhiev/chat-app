...
test_data = [
    ...
    ({"language": "EN", "email": ""}, {"status": 400, "json":{'fail': ['empty-email']}}),
    ({"language": "EN", "email": "sadas.example.com"}, {"status": 400, "json":{'fail': ['invalid-email']}}),
    ({"language": "EN", "email": "aleks@example.com"}, {"status": 400, "json":{'fail': ['user-not-found']}}),
    ({"language": "EN", "email": "unverified@gmail.com"}, {"status": 400, "json":{'fail': ['unverified']}}),
    ({"language": "EN", "email": "aleks_01_@gmail.com"}, {"status": 200, "json":{'message': "success"}}),
]

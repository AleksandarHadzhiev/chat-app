...
def generate_json(translations: Base):
    full = {"translations": translations.get_translations()}
    return full


test_data = [
    (
        "/languages/translations/EN/login",
        {"status": 200, "json": generate_json(LoginTranlsations())},
    ),
    (
        "/languages/translations/NL/login",
        {"status": 200, "json": generate_json(DutchLoginTranlsations())},
    ),
    (
        "/languages/translations/EN/emails",
        {"status": 200, "json": generate_json(EnglishEmailsTranslations())},
    ),
    (
        "/languages/translations/NL/emails",
        {"status": 200, "json": generate_json(DutchEmailsTranslations())},
    ),
    (
        "/languages/translations/EN/registration",
        {"status": 200, "json": generate_json(RegistrationTranslations())},
    ),
    (
        "/languages/translations/NL/registration",
        {"status": 200, "json": generate_json(DutchRegistrationTranslations())},
    ),
    (
        "/languages/translations/EN/reset_password",
        {"status": 200, "json": generate_json(ResetPasswordTranslations())},
    ),
    (
        "/languages/translations/NL/reset_password",
        {"status": 200, "json": generate_json(DutchResetPasswordTranslations())},
    ),
    (
        "/languages/translations/EN/groups",
        {"status": 200, "json": generate_json(GroupsEnglishTranlsations())},
    ),
    (
        "/languages/translations/NL/groups",
        {"status": 200, "json": generate_json(GroupsDutchTranlsations())},
    ),
    (
        "/languages/translations/EN/forgot_password",
        {"status": 200, "json": generate_json(ForgotPasswordTranslations())},
    ),
    (
        "/languages/translations/NL/forgot_password",
        {"status": 200, "json": generate_json(DutchForgotPasswordTranslations())},
    ),
    (
        "/languages/translations/EN/messages",
        {"status": 200, "json": generate_json(MessagesEnglishTranlsations())},
    ),
    (
        "/languages/translations/NL/messages",
        {"status": 200, "json": generate_json(MessagesDutchTranlsations())},
    ),
    (
        "/languages/translations/EN/navigation",
        {"status": 200, "json": generate_json(NavigationEnglishTranlsations())},
    ),
    (
        "/languages/translations/NL/navigation",
        {"status": 200, "json": generate_json(NavigationDutchTranlsations())},
    ),
]

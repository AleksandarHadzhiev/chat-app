...
test_data = [
    (0, 0, 0, {"status": 400, "json":{'fail': ['invalid-group_id', 'invalid-user_id', 'invalid-member_id']}}),
    (0, 1, 1, {"status": 400, "json":{'fail': ['invalid-group_id']}}),
    (0, 0, 1, {"status": 400, "json":{'fail': ['invalid-group_id', 'invalid-member_id']}}),
    (0, 1, 0, {"status": 400, "json":{'fail': ['invalid-group_id', 'invalid-user_id', ]}}),
    (1, 1, 0, {"status": 400, "json":{'fail': ['invalid-user_id', ]}}),
    (1, 0, 0, {"status": 400, "json":{'fail': ['invalid-user_id', 'invalid-member_id']}}),
    (1, 12, 1, {"status": 400, "json":{'fail': 'not-member'}}),
    (2, 1, 2, {"status": 400, "json":{'fail': 'Unauthorized to remove member from group'}}),

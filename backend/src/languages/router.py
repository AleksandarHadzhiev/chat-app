...
class LanguagesRouter():
    def __init__(self, db, settings):
        ...
        self.router.add_api_route("/translations/{language}/{file}", self.controller.get_translations, methods=["GET"])
        self.router.add_api_route("/translations", self.controller.add_translations, methods=["POST"])